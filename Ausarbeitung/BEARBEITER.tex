...
\usepackage{imakeidx}               % Indexpaket
...
\author{Vorname Nachname} % Name des Autors
\date{\today}
\studiengang{Bachelorstudiengang Informatik}
\arbeitstyp{Bachelorarbeit}
\erstgutachter{Prof. Dr. Dr. h.c. H.-J. Appelrath}
\zweitgutachter{Prof. Dr.-Ing. Zweiter Gutachter}
